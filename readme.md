...
<p align="center">
  <img src="docs/confidence_levels.png" alt="Overview of confidence level requirements" width="600"><br>
  <em>Figure 1. Overview of confidence level requirements. Final assigned confidence levels in Stage 5 output were determined using a post-hoc adjustment based upon approach C (evidence ceiling) to more correctly capture annotation supporting evidence. Note: Level 4 assignments correspond to Schymanski Level 1 confidence levels. Level 3 and 2 can be considered Schymanski Level 4. Level 1 and lower are consistent with Schymanski Level 5.</em>
</p>
